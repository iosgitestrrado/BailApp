...
open class FadedScrollView: UIScrollView {
    ...
    override open func layoutSubviews() {
        if self.fadeBottom || self.fadeBottom {
            ...
            solidLayer.backgroundColor = UIColor.red.cgColor
            ...
            if self.fadeTop {
                ...
                topLayer.colors = [UIColor.red.cgColor, UIColor.green.cgColor]
            ...
            if self.fadeBottom {
                ...
                bottomLayer.colors = [UIColor.green.cgColor, UIColor.clear.cgColor]
