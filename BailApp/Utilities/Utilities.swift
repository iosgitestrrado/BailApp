...
class func shadowColoreffect(setView :UIView){
    
    setView.layer.cornerRadius = 10.0
    setView.layer.shadowColor = UIColor.blue.cgColor
    setView.layer.shadowOffset = .zero
    setView.layer.shadowOpacity = 0.7
    setView.layer.shadowRadius = 12.0
...
//        mainController.present(activityViewController, animated: true) { _ in }
